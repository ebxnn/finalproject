...
const DecorationPage = () => {
  ...
  const [filter, setFilter] = useState('Decoration'); // State for filtering to decoration category
  ...
  const fetchProducts = async () => {
    ...
    try {
      const response = await fetch(`${BASE_URL}/api/products/view?category=Decoration`, {
        method: 'GET',
        headers: {
  ...
  return (
    <div className="product-page">
      ...
      <h1 className="page-title">Decoration Collection</h1>
